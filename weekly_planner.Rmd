...
* Check 'weekly_planner.Rmd' file for the code. If you want to add as many columns as you want. If you want to change the table features, please take a look at the gt package documentation. 
